...
def main(data_path):
    ...
    print('Preparing data for encoder and decoder...')
    ...
    model = load_model(os.path.join(data_path,'model_attention_60.h5'))
...
if __name__ == "__main__":
    print('Scanning through the corpus to build the chatbot!...')
    print('Running the Seq2Seq model with Attention mechanism...')
    nltk.download('punkt')
